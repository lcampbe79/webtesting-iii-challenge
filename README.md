...
- [x] Submit a Pull-Request to merge the `<firstName-lastName>` branch into the master branch on your fork. **Please don't merge you own pull request**
...
- the open toggle button is disabled if the gate is open
